# Generated by Django 5.0 on 2025-05-07 05:29
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('config_type', models.CharField(choices=[('hourly_rate', '每小时费率(元)'), ('free_duration', '免费停车时长(分钟)'), ('reservation_expiry', '预订过期时间(分钟)')], max_length=20, unique=True, verbose_name='配置类型')),
                ('value', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='配置值')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_number', models.CharField(blank=True, default=parking_app.models.generate_order_number, max_length=50, null=True, unique=True, verbose_name='订单号')),
                ('payment_amount', models.DecimalField(decimal_places=2, default=0, max_digits=10, verbose_name='支付金额')),
